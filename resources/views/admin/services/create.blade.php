    ...
    <div class="bg-white rounded-2xl shadow p-8">
        ...
        <form method="POST" action="{{ route('admin.services.store') }}" class="space-y-5">
            ...
            <div><label class="block text-sm font-medium text-gray-700 mb-1">عنوان الخدمة *</label>
                <input type="text" name="title" value="{{ old('title') }}" required class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
            ...
            <div><label class="block text-sm font-medium text-gray-700 mb-1">الأيقونة (Emoji)</label>
                <input type="text" name="icon" value="{{ old('icon') }}" placeholder="🏠" class="w-24 border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 text-2xl">
            </div>
            <div><label class="block text-sm font-medium text-gray-700 mb-1">السعر (ريال)</label>
                <input type="number" name="price" value="{{ old('price') }}" min="0" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
